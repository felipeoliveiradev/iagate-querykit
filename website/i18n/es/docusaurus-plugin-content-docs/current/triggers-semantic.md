...
title: Disparadores Semánticos
---

Disparadores a nivel de aplicación con `when`, `action`, `except`, `table` y `body`.
...
`action` como array y múltiples tablas:
```ts
...
body: string / función / array / paralelo:
```ts
