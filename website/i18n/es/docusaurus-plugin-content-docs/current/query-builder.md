...
`QueryBuilder<T>(table)` es una API fluida para construir SQL tipado y ejecutar vía un ejecutor configurado.

```ts
// Construcción y tracking
...
Agrupación / HAVING / Ordenación / Paginación:
```ts
